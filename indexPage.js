...
window.onload = function () {
  ...
  renderDynamicOptions2();
  renderDynamicOptions3();
};
...
function onSelectValChg(type) {
  const feetTab = document.getElementById("feetTab");
...
function selectColor(clr, callFrom) {
  formVal.color = clr;
  colors.map((color, index) => {
    if (color == clr) {
      const colorDiv = document.getElementById(`color${callFrom}${index + 1}`);
...
function getFormValues() {
  ...
  resetForm(eidtPerson ? 2 : 1);
  handleSubmit(maxGraphHeght);
}

function resetForm(callFrom) {
  chgGenderVal(1);
  onSelectValChg(1);
  document.getElementById("nameInput").value = null;
  document.getElementById("feetInput").value = null;
  document.getElementById("cmInput").value = null;
  colors.map((color, index) => {
    const colorDiv = document.getElementById(`color${callFrom}${index + 1}`);
    colorDiv.classList.remove("border-primary");
  });
...
function colorDivGenrator(callFrom) {
  ...
  if (callFrom == 2) {
    ...
    mainContainer = document.getElementById("colorsDiv4");
    mainContainer.innerHTML = "";
  } else {
  ...
  colors.forEach((color, index) => {
    ...
    outerDiv.id = `color${callFrom}${index + 1}`;
    ...
    outerDiv.onclick = () => selectColor(color, callFrom);
...
function renderDynamicOptions() {
  ...
  $(".piker1").selectpicker("refresh");
}

function renderDynamicOptions2() {
  // Array of options
  var options = nbaPlayers;

  var select = document.getElementById("dynamicSelect2");
...
function handleSelectChange(callFrom) {
  ...
  select.addEventListener("change", function () {
    ...
    for (let i = 0; i < clebData.length; i++) {
      const element = clebData[i];
...
const nbaPlayers = [
  ...
  { id: 2, name: "AJ Green", heightFeet: 6.33, heightCm: 193.04, type: "NBA" },
  { id: 3, name: "AJ Griffin", heightFeet: 6.5, heightCm: 198.12, type: "NBA" },
  {
    id: 4,
    name: "Aaron Gordon",
    heightFeet: 6.67,
  ...
  { id: 16, name: "Alex Len", heightFeet: 7, heightCm: 213.36, type: "NBA" },
  {
    id: 17,
  ...
  { id: 48, name: "Bol Bol", heightFeet: 7.25, heightCm: 220.98, type: "NBA" },
  {
    id: 49,
    name: "Bones Hyland",
    heightFeet: 6.17,
  ...
  { id: 84, name: "Chris Paul", heightFeet: 6, heightCm: 182.88, type: "NBA" },
  {
    id: 85,
  ...
  { id: 198, name: "Ibou Badji", heightFeet: 7, heightCm: 213.36, type: "NBA" },
  {
    id: 199,
  ...
  { id: 209, name: "Ish Smith", heightFeet: 6, heightCm: 182.88, type: "NBA" },
  {
    id: 210,
    name: "Ish Wainright",
    heightFeet: 6.42,
  ...
  { id: 214, name: "JT Thor", heightFeet: 6.75, heightCm: 205.74, type: "NBA" },
  {
    id: 215,
    name: "Ja Morant",
    heightFeet: 6.17,
  ...
  { id: 263, name: "Jay Huff", heightFeet: 7.08, heightCm: 215.9, type: "NBA" },
  {
    id: 264,
    name: "Jaylen Brown",
    heightFeet: 6.5,
  ...
  { id: 356, name: "Kyle Lowry", heightFeet: 6, heightCm: 182.88, type: "NBA" },
  {
    id: 357,
    name: "Kyrie Irving",
    heightFeet: 6.17,
  ...
  { id: 412, name: "Mo Bamba", heightFeet: 7, heightCm: 213.36, type: "NBA" },
  {
    id: 413,
    name: "Monte Morris",
    heightFeet: 6.17,
  ...
  { id: 535, name: "Tre Mann", heightFeet: 6.25, heightCm: 190.5, type: "NBA" },
  {
    id: 536,
...
const footballPlayer = [
  ...
  { id: 55, name: "Neto", heightFeet: 6.25, heightCm: 191, type: "football" },
  {
    id: 56,
  ...
  { id: 132, name: "Neto", heightFeet: 6.25, heightCm: 191, type: "football" },
  {
    id: 133,
    name: "Jasper Cillessen",
    heightFeet: 6.17,
  ...
  { id: 188, name: "Neto", heightFeet: 6.25, heightCm: 191, type: "football" },
  {
    id: 189,
    name: "Jasper Cillessen",
    heightFeet: 6.17,
  ...
  { id: 266, name: "Neto", heightFeet: 6.25, heightCm: 191, type: "football" },
  {
    id: 267,
    name: "Jasper Cillessen",
    heightFeet: 6.17,
  ...
  { id: 402, name: "Neto", heightFeet: 6.25, heightCm: 191, type: "football" },
  {
    id: 403,
    name: "Jasper Cillessen",
    heightFeet: 6.17,
  ...
  { id: 460, name: "Neto", heightFeet: 6.25, heightCm: 191, type: "football" },
  {
    id: 461,
    name: "Jasper Cillessen",
    heightFeet: 6.17,
  ...
  { id: 539, name: "Neto", heightFeet: 6.25, heightCm: 191, type: "football" },
  {
    id: 540,
    name: "Jasper Cillessen",
    heightFeet: 6.17,
  ...
  { id: 656, name: "Neto", heightFeet: 6.25, heightCm: 191, type: "football" },
  {
    id: 657,
    name: "Jasper Cillessen",
    heightFeet: 6.17,
